...
public class JanelaPrincipal extends JFrame implements ActionListener{
	...
	public void instanciaComponentes() {
		...
		banner = new JLabel("Super agenda");
	...
	public void actionPerformed(ActionEvent e) {
            ...
            if (((JButton)e.getSource()).getText().equals(" Inserir ")) {
                ...
                if(agenda.inserirContato(contato)) {
                    JOptionPane.showMessageDialog(this, "Contato salvo com sucesso!", "Inclusão", JOptionPane.INFORMATION_MESSAGE);
                    limparTela();
                }
            }
            ...
            if (((JButton)e.getSource()).getText().equals(" Salvar ")) {
